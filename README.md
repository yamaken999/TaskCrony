...
**配布版のダウンロード:**
1. **[Releases ページ](https://github.com/yamaken999/TaskCrony/releases)** にアクセス
2. `TaskCrony_v0.1.0_Distribution.zip` をダウンロード
3. ZIPファイルを解凍して `TaskCrony.exe` を管理者権限で実行

> **注意:** 初回リリース作成後、上記リンクからダウンロード可能になります
